...
<!-- End Login Modal -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> <i class="fa fa-search"></i> Product
                ...
                <ol class="breadcrumb">
                    ...
                    <?php
                      print '<li> <a href="category-1.php?username='.$user.'">Generic Categories Template</a>
                    		</li>';
                    ?>
                    <li class="active">Generic Review Details Template
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel panel-info">
                	...
                	<div class="panel-body">
	                	...
	                	<dl class="list-unstyled">
	                		<dt> Rule 1. Generic category rule </dt>
	                		<dd> This is a description of the rule above</dd>
				...
				<div class="panel panel-info">
                	<div class="panel-heading panel-primary"> <strong> Generic Moderators </strong> </div>
                	<div class="panel-body">
                		<h5 class="pq-header"> <strong> Message the Mods! </strong> </h5>
                		<div class="list-group" class="pq-mod-list">
                			<a href="#" data-container="body" data-toggle="modal" data-recipient="@Moderator" data-target="#message" 
                			class="btn list-group-item  <?php print $element->SetDisabled(); ?>"  ><i class="fa fa-key"></i> Moderator </a>

                			<a href="#" data-container="body" data-toggle="modal" data-recipient="@Moderator_2" data-target="#message" 
                			class=" btn list-group-item  <?php print $element->SetDisabled(); ?> " ><i class="fa fa-key"></i> Moderator_2 </a>
            ...
            <div class="col-md-8">
            	        <div class="panel panel-primary">
            	            <div class="panel-heading">Product Review
            	                ...
            	                <div class="panel-body" role="tabpanel">
					                ...
					                <div id="myTabContent" class="tab-content">
					                    <div class="tab-pane fade active in" id="descriptionPane">
		            	                    ...
		            	                    <p><img class="img-responsive img-hover" src="http://placehold.it/700x300" alt=""></p> 
		            	                    ...
		            	                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa.
    											...
    											Mauris et orci. Aenean nec lorem.</p>
    ...
    <script type="text/javascript">
        ...
        $('#reply').on('show.bs.modal', function (event) {
          ...
          var modal = $(this)
          if (replytype == 'main'){
            modal.find('.modal-title').text('Reply to ' + recipient + ' review of Product')            
          }else{
