...
?>			
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Welcome to People's Q!
				<small> Admin 04/02/2015 16:00 </small>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <p class="text-right"><a href="#" data-container="body" data-toggle="modal" data-recipient="@Admin" data-target="#reply" class="btn btn-default btn-sm"><i class="fa fa-reply"></i> reply</a></p>
            </div>
            <hr>
        </div>
        <!-- /.row -->
